...
class CsvSlurperController extends GenericSlurperController
{
    ...
    def get()
    {
        ...
        Feed feed = CsvFormatHelper.ingest( new InputStreamReader( url.openStream() ), params.idl )
    ...
    def post()
    {
        ...
        Feed feed = CsvFormatHelper.ingest( new StringReader( file.getInputStream().getText() ), params.idl )
        super.formatOutput( feed )
    }
