...
<head>
    ...
    <title>CSV Slurper Documentation and Sandbox</title>
</head>

<body>

    <h2>REST Service Documentation and Sandbox for /csvSlurper</h2>

    <p>This service processes a non-streaming CSV-formatted data feed, and outputs it in one of the supported output formats.</p>
    <p>There are 2 ways to use this service:</p>
    <ul>
        <li><a href="#getUrl"><tt>GET /DataEngine/csvSlurper</tt></a> processes a CSV file specified at a URL</li>
        <li><a href="#POST"><tt>POST /DataEngine/csvSlurper</tt></a> processes an uploaded CSV file</li>
    </ul>

    <h3>Syntax</h3>
    <pre>/DataEngine/csvSlurper</pre>
    ...
    <table class="table">
        <tr>
            ...
            <td>response MIME type.  This should not normally be used, since the service returns the correct MIME type for each format (see below), however,
                ...
                <ul>
                    <li><a href="/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv&format=JSON&force_mime_type=text/plain">/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv&force_mime_type=text/plain</a>
        ...
        <tr>
            ...
            <td>output format.  Currently, the following formats are supported:
                ...
                For example,
                <ul>
                    <li>default (JSON):  <a href="/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv">/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv</a></li>
                    <li>CWL:  <a href="/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv&format=CWL">/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv&format=CWL</a></li>
                    <li>TEXT:  <a href="/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv&format=TEXT">/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv&format=TEXT</a></li>
                </ul>
            </td>
        </tr>
        <tr>
            ...
            or it can be a full URL to an IDL resource on this or any other server.
                <ul>
                    <li><a href="/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv&idl=1">/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv&idl=1</a>
        ...
        <tr>
            ...
            <td>fully qualified data feed endpoint URL, for example
                <ul>
                    <li>Simple CSV file:  <a href="/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv">/DataEngine/csvSlurper?url=http://localhost:8080/DataEngine/sample_files/simple.csv</a></li>
                </ul>
            </td>
        </tr>
    </table>
    ...
    <g:form controller="csvSlurper" class="form-horizontal" action="play" method='post' enctype='multipart/form-data' >
        <fieldset>
            <div id="legend" class="">
                <legend class="">CSV Slurper</legend>
            </div>
