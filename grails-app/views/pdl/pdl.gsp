...
<head>
    ...
    <title>PDL Documentation</title>
</head>

<body>

    <h2>PDL Documentation</h2>

    <p>The Process Description Language is a DSL written using JSON to describe a data feed.  This enables
    ...
    <p>PDLs are used throughout the DataEngine, usually using the PDL's UUID as a shorthand for specifying a data feed.
        The UUID is generated via the <a href="/DataEngine/idl/index.gsp">PDL REST services</a>, which provides full CRUD services for working with PDLs in the system.
    </p>

    <h3>Examples</h3>
    <p>The following is a simple example of a PDL file.</p>
    <pre>
{
    "version":"Process Description Language (PDL) v1.1301.23",
    "idl_uuid":12345,
    ...
    <p>As with any JSON file, the PDL is a set of key/value pairs.  Some keys point to Strings, some to numbers,
    ...
    <p>Some additional samples:
        <ul>
            <li><a href="/DataEngine/sample_files/join_data_1_idl.json">Simple PDL for a local cache of a wikimapia feed of hospitals</a></li>
            <li><a href="/DataEngine/sample_files/join_data_2_idl.json">Simple PDL for a local CSV file</a></li>
        </ul>
    </p>
    ...
    <table class="table">
        <tr>
            ...
            <td>the date this PDL was first posted - it follows the ISO 8601 convention for combined date and time.</td>
        </tr>
        <tr>
            <td><strong>idl_uuid</strong> (generated)</td>
            <td>the PDL UUID on this system - this is assigned when a POST /idl request is made.  It can be
        ...
        <tr>
            ...
            <td>specifications for how to treat items in a data feed - this is the heart of the PDL, and is described
                in detail below.</td>
        </tr>
        <tr>
            <td><strong>modificationDate</strong> (generated)</td>
            <td>the date this PDL was last updated - it follows the ISO 8601 convention for combined date and time.</td>
        </tr>
        <tr>
        ...
        <pre>
{
    ...
    <p>The String type is the most basic type, used for any text strings.  It is the default for all columns/tags/fields in a data feed
        if a PDL is not specified.  Its generic form is <pre><tt>"name": [ "String", "newName" ]</tt></pre>
    </p>
    <table>
        <tr>
            <td><strong><tt>"new name"</tt></strong></td>
